...
const SLOT_ORDER = ['S1', 'S2', 'S3', 'S4', 'A1', 'A2', 'Dom', 'RCT', 'Ult', 'SD'];
const SLOT_CATEGORY = { S1: 'Special', S2: 'Special', S3: 'Special', S4: 'Special', A1: 'Ability', A2: 'Ability', Dom: 'Domain', RCT: 'RCT', Ult: 'Ultimate', SD: 'Simple Domain' };
const SLOT_LABEL = { S1: 'Special 1', S2: 'Special 2', S3: 'Special 3', S4: 'Special 4', A1: 'Ability 1', A2: 'Ability 2', Dom: 'Domain', RCT: 'Reverse Cursed Technique', Ult: 'Ultimate', SD: 'Simple Domain' };
let prog = JSON.parse(localStorage.getItem(PROG_KEY)) || JSON.parse(localStorage.getItem('jjc_prog_v7')) || null;
if (!prog) {
    prog = { unlocked: ['Divergent Fist'], eq: { S1: 'Divergent Fist', S2: null, S3: null, S4: null, A1: null, A2: null, Dom: null, RCT: null, Ult: null, SD: null }, ceMaxUnlocked: 300, highestBot: null, unlockLog: {}, beaten: {} };
} else {
...
function renderCharDrops() {
    const allDrops = {
        ...
        'Shinjuku Itadori': ['Prince of Black Flash', 'Ultimate Dark Flash', 'Cursed Existence', 'Simple Domain'],
    };
...
function executeTech(name, isAI, r, c) {
    ...
    const _noEndTurn = ['Reverse Cursed Technique', 'Idle Transfiguration', 'Infinity',
        ...
        'Time Cell Moon Palace', 'Chimera Shadow Garden', 'Simple Domain', 'Cursed Existence'];
